                ...
                <table class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      echo "<td>" . $row['role'] . "</td>";
                      echo "<td>
                                    <a href='deleteuser.php?id=" . $row['id'] . "' class='action-btn btn-delete' onclick='return confirm(\"Yakin untuk menghapus user?\");'>Delete</a>
                                    </td>";
                    }
                    // <a href=edituser.php?id=" . $row['id'] . " class='action-btn btn-edit'>Edit</a>
                    ?>
                  </tbody>
                </table>
              </div>
