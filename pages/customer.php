...
<div class="content">
  <button class="btn-pink" onclick="window.location.href='add_customer.php';">
    Add
  </button>
                    ...
                    <div class="table-wrapper">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                $result = mysqli_query($conn, "SELECT * FROM pelanggan ORDER BY created_at DESC");

                                // Loop melalui hasil dan tampilkan di tabel
                                // untuk fetch data dari database (array asosiatif)
                                while ($row = mysqli_fetch_assoc($result)) {
                                    echo "<tr>";
                                    echo "<th scope='row'>" . $row['id_pelanggan'] . "</th>";
                                    echo "<td>" . $row['nama_pelanggan'] . "</td>";
                                    echo "<td>" . $row['alamat'] . "</td>";
                                    echo "<td>" . $row['no_telp'] . "</td>";
                                    echo "<td>
                                        <a href='editcustomer.php?id=" . $row['id_pelanggan'] . "' class='action-btn btn-edit'>Edit</a>
                                        <a href='deletecustomer.php?id=" . $row['id_pelanggan'] . "' class='action-btn btn-delete' onclick='return confirm(\"Yakin untuk menghapus pelanggan?\");'>Delete</a>
                                    </td>";
                                }
                                ?>
                            </tbody>
